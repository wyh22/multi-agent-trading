...
def create_fundamentals_analyst(llm, tools=None):
    def fundamentals_analyst_node(state):
        ...
        if "search_company_knowledge" in active_tool_names:
            rag_guidance = (
                " When available, use search_company_knowledge for annual reports, "
                "financial-note disclosures, impairment/accounting-policy details, "
                "and other PIT-aware document evidence that structured statement "
                "tools do not expose. Always pass the current research cutoff date."
            )
